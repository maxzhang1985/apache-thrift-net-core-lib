    ...
    public class TMultiplexedProcessor : ITAsyncProcessor
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    await
                        FailAsync(oprot, message, TApplicationException.ExceptionType.InternalError,
                ...
                var newMessage = new TMessage(
                    message.Name.Substring(serviceName.Length +
                                           TMultiplexedProtocol.Separator.Length),
                    message.Type,
                    message.SeqID);
                ...
                return
                    await
                        actualProcessor.ProcessAsync(new StoredMessageProtocol(iprot, newMessage),
                            oprot,
                            cancellationToken);
            }
            catch (IOException)
