...
namespace Thrift.Transports.Server
{
    ...
    public class THttpServerTransport
    {
        ...
        public THttpServerTransport(ITAsyncProcessor processor, RequestDelegate next,
            ILoggerFactory loggerFactory)
            : this(processor, new TBinaryProtocol.Factory(), next, loggerFactory)
        {
        }

        public THttpServerTransport(ITAsyncProcessor processor, ITProtocolFactory protocolFactory,
        ...
        public THttpServerTransport(ITAsyncProcessor processor,
            ...
            ITProtocolFactory outputProtocolFactory, RequestDelegate next,
            ILoggerFactory loggerFactory)
        {
            if (processor == null)
            {
