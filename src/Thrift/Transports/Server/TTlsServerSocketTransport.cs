...
namespace Thrift.Transports.Server
{
    ...
    public class TTlsServerSocketTransport : TServerTransport
    {
            ...
            if (_server != null)
            {
                ...
                catch (SocketException sx)
                {
                    throw new TTransportException(
                        $"Could not accept on listening socket: {sx.Message}");
                }
            }
        }
        ...
        protected override async Task<TClientTransport> AcceptImplementationAsync(
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var tTlsSocket = new TTlsSocketClientTransport(client, _serverCertificate, true,
                    _clientCertValidator, _localCertificateSelectionCallback, _sslProtocols);
