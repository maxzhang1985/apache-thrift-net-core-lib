...
namespace Thrift.Transports.Client
{
    ...
    public class TTlsSocketClientTransport : TStreamClientTransport
    {
        ...
        public TTlsSocketClientTransport(TcpClient client, X509Certificate2 certificate,
            bool isServer = false,
            ...
            SslProtocols sslProtocols = SslProtocols.Tls12)
        {
            ...
            if (isServer && certificate == null)
            {
                throw new ArgumentException(
                    "TTlsSocketClientTransport needs certificate to be used for server",
                    "certificate");
            }
        ...
        private bool DefaultCertificateValidator(object sender, X509Certificate certificate,
            X509Chain chain, SslPolicyErrors sslValidationErrors)
        {
        ...
        public async Task SetupTlsAsync()
        {
            ...
            try
            {
                if (_isServer)
                {
                    ...
                    await
                        _secureStream.AuthenticateAsServerAsync(_certificate, _certValidator != null,
                            _sslProtocols, true);
                }
                else
                {
                    ...
                    await
                        _secureStream.AuthenticateAsClientAsync(_host.ToString(), certs,
                            _sslProtocols, true);
                }
            }
            catch (Exception)
