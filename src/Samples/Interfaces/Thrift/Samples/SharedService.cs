    ...
    public partial class SharedService
    {
        ...
        public class AsyncProcessor : ITAsyncProcessor
        {
            ...
            protected Dictionary<string, ProcessFunction> processMap_ =
                new Dictionary<string, ProcessFunction>();
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("GetStruct", TMessageType.Reply, seqid), cancellationToken);
                ...
                catch (Exception ex)
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("GetStruct", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
