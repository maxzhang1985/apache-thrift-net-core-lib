        ...
        public class AsyncProcessor : SharedService.AsyncProcessor, ITAsyncProcessor
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Ping", TMessageType.Reply, seqid), cancellationToken);
                ...
                catch (Exception ex)
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Ping", TMessageType.Exception, seqid), cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                await oprot.Transport.FlushAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                {
                    result.Success =
                        await _iAsync.@AddAsync(args.Num1, args.Num2, cancellationToken);
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Add", TMessageType.Reply, seqid), cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                {
                ...
                catch (Exception ex)
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Add", TMessageType.Exception, seqid), cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                await oprot.Transport.FlushAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    {
                        result.Success =
                            await _iAsync.CalculateAsync(args.Logid, args.W, cancellationToken);
                    }
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Calculate", TMessageType.Reply, seqid), cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                {
                ...
                catch (Exception ex)
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(
                            new TMessage("Calculate", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
